...
local Window = OrionLib:MakeWindow({Name = "[⚡ANIME] UPDATE - PSX SCAM TRADE PRIVATE V4.0 HidePremium = false, SaveConfig = true, IntroText = 8888 Team, ConfigFolder = "OrionTest"})
...
local Tab = Window:MakeTab({
    ...
    Tab:AddParagraph("[⚡ANIME] UPDATE","Version 4.0")
    ...
    Tab:AddButton({
        ...
        Callback = function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/Maset0/PSX/Scripts/VIP.lua"))()
          end    
    })
